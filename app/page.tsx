  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 md:px-10">
      ...
      <div className="relative z-10 mx-auto max-w-5xl text-center">
        <p className="mb-6 text-sm uppercase tracking-[0.24em] text-primary md:text-base">Bits by Grifi</p>
        <h1 className="text-5xl font-bold leading-[0.98] text-foreground md:text-7xl">One-click product demos for your e-commerce</h1>
        <p className="mx-auto mt-7 max-w-2xl text-base text-muted-foreground md:text-2xl">
          Paste your product link, and we&apos;ll generate a professional video ad for Amazon, Blinkit, and beyond in minutes.
        </p>
        <Button 
          size="lg" 
